...
async def adaptive_translate_tool(
    ...
    try:
        print(f"Triggering clean Cloud Translation API Advanced document translation...")
        ...
        print(f"Successfully saved translated document to {output_file_path}")
...
def inspect_translation_proof(file_path: str, glossary_terms: list, source_content: Optional[str] = None) -> dict:
    ...
    Args:
        file_path: Absolute path to the translated PDF document to inspect.
        glossary_terms: List of expected terminology terms.
        source_content: The text from the original source document to avoid false positives.
    """
